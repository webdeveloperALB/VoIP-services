          ...
          <div className="space-y-4 md:space-y-6 lg:space-y-8">
            ...
            <div className="space-y-3 md:space-y-4 lg:space-y-6">
              {[
                ...
                <div
                  key={index}
                  className="binary-hover p-3 sm:p-4 md:p-6 bg-gradient-to-br from-gray-900/80 to-black/70 border border-gray-700/60 rounded-xl hover:border-cyan-400/70 transition-all duration-300"
                >
