...
const Header = () => {
  ...
  const [isContactOpen, setIsContactOpen] = useState(false); // for mobile dropdown
            ...
            {location.pathname === "/tutorials" ? (
              ...
              <>
                ...
                <div className="relative group">
                  <button
                    className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 flex items-center space-x-1 text-sm xl:text-base"
                  >
                    <span>Contact</span>
            ...
            <nav className="flex flex-col space-y-3 sm:space-y-4 mt-3 sm:mt-4">
              {location.pathname === "/tutorials" ? (
                ...
                <>
                  ...
                  {/* Contact dropdown for mobile (tap to expand) */}
                  <div className="flex flex-col">
                    <button
                      onClick={() => setIsContactOpen(!isContactOpen)}
                      className="flex items-center justify-between text-gray-300 hover:text-cyan-400 text-sm sm:text-base py-1"
                    >
                      <span>Contact</span>
                      <ChevronDown
                    ...
                    {isContactOpen && (
                      <div className="ml-4 mt-1 flex flex-col space-y-1">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-gray-300 hover:text-cyan-400 text-sm sm:text-base py-1"
                        >
                          WhatsApp
                        </a>
                        <a
